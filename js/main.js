...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    // Crear un enlace mailto con los valores del formulario
    const mailtoLink = `mailto:jeremyagnz@gmail.com?subject=${encodeURIComponent(
    ...
    I am writing to request additional information regarding the following matter.
    Below are the details for your review:
    ...
    Thank you in advance for your attention to this request. I look forward to your response and am available for any further information you may need.
